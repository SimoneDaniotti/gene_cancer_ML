...
\title{Multiclassification on gene expression data}% Force line breaks with \\
...
The dataset for this work is taken from UCI Machine Learning Repo (available at \url{https://archive.ics.uci.edu/ml/datasets/gene+expression+cancer+RNA-Seq}); this is part of the RNA-Seq (HiSeq, a tool for measuring gene expression) PANCAN data set. It is a collection of gene expressions of patients having different types of tumor: BRCA(breast), KIRC(kidney), COAD(colon), LUAD(lung) and PRAD(prostate).

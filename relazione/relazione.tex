...
\caption{On the left: Confusion matrix for the Pytorch Deep Neural Network with Label Encoding. On the right: Confusion matrix for the Pytorch Deep Neural Network with One-Hot Encoding.}
\label{fig_torch}
\end{figure}
